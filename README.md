...
[2019年8月20日改訂第3.0版](https://github.com/textlint-ja/textlint-rule-preset-JTF-style/blob/master/jtf_style_guide3.0.pdf)を元にしています。
...
JTFスタイルガイドは第3.0版から「CC BY 4.0」に変更されました（第2.3版以前は「CC BY-SA 4.0」です）。
