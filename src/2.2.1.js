...
『用字用語 新表記辞典第四版』（第一法規）および『日本語スタイルガイド（第3版）』（テクニカルコミュニケーター協会編著）の「付録1 漢字とひらがなの使い分け」を主たる参考文献とします。
特にマニュアルやウェブサイトなど、製品やサービスにともなって提供される文書を和訳する際には、
『日本語スタイルガイド（第3版）』（テクニカルコミュニケーター協会編著）の「付録1 漢字とひらがなの使い分け」を参考にします。
実務翻訳では、業種や分野により異なる慣例に従って、ひらがなと漢字が使い分けられています。
同じ語句を漢字とひらがなのどちらを使っても表記できる場合、特許、金融、法律の分野では漢字で書き、情報処理、ローカライズなどの分野ではひらがなで書く傾向があります。
